            ...
            <Swiper
                ...
                <SwiperSlide>
                    <SliderItem>
                        <SliderImageContainer>
                            <img
                                src={`${process.env.PUBLIC_URL}/assets/images/Homepage Slider/Tshirtlast.jpg`}
                                alt=""
                            />
                        </SliderImageContainer>
                        <SliderTextContainer>
                ...
                <SwiperSlide>
                    <SliderItem>
                        <SliderImageContainer>
                            <img
                                src={`${process.env.PUBLIC_URL}/assets/images/Homepage Slider/grocerylast.jpg`}
                                alt=""
                            />
                        </SliderImageContainer>
                        <SliderTextContainer>
                ...
                <SwiperSlide>
                    <SliderItem>
                        <SliderImageContainer>
                            <img
                                src={`${process.env.PUBLIC_URL}/assets/images/Homepage Slider/headphoneslast.jpg`}
                                alt=""
                            />
                        </SliderImageContainer>
                        <SliderTextContainer>
                ...
                <SwiperSlide>
                    <SliderItem>
                        <SliderImageContainer>
                            <img
                                src={`${process.env.PUBLIC_URL}/assets/images/Homepage Slider/medicinelast.jpg`}
                                alt=""
                            />
                        </SliderImageContainer>
                        <SliderTextContainer>
